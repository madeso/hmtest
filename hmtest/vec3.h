...
public:
	...
	float getDotProduct(const vec3& r) const;
...
namespace op {
	...
	public:
		...
		::vec3 static getLinearInterpolation(const ::vec3& from, float value, const ::vec3& to);
		void static getLinearInterpolation(const ::vec3& from, float value, const ::vec3& to, ::vec3* out);
